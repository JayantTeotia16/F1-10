...
class ControlTurtlesim():
	...
	#self.po = rospy.Subscribe('/turtle1/pose', Pose)
        move_cmd.linear.x = input("Linear velocity(x) - ")	# Modify this value to change the Turtle's speed

        # Turn at 0 radians/s
	
        move_cmd.angular.z = input("Angular velocity(z) - ")
	...
	tin = round(thet,1)
	    ...
	    if(round(thet,1) == tin):
                move_cmd.angular.z = 0 - move_cmd.angular.z
